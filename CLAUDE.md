...
MCP server platform exposing D365FO metadata as 71 AI-consumable tools across 4 services (KB 32, XRef 18, Security 19, Task Recorder 2). 65 read a local snapshot; 4 read sealed-ISV metadata; 1 (`d365_custom_fields`) reads a live D365 environment; 1 (`d365_knowledge`) serves a curated rulebook shipped with the code.
