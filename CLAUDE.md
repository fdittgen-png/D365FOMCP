...
MCP server platform exposing D365FO metadata as 61 AI-consumable tools across 4 services (KB, XRef, Security, Task Recorder). 56 read a local snapshot; 4 read sealed-ISV metadata; 1 (`d365_custom_fields`) reads a live D365 environment.
