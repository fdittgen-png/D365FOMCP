...
open:      investigation { id, purpose: dashboard|report|app|migration_mapping|dq_rule|support|process_analysis|comparison|other,
                           ...
                           expected_entities?: identifier[]≤20 }
