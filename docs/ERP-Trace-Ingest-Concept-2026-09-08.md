...
Decision 1 confirmed and phases 1–2 built on 2026-09-08. Still needing Florian: the phase-3 Entra app registration (an admin action — see the phase table), then the MCP app settings and the measurement of connector-side correlation before turning `REQUIRE_AUTH=bearer` on.
